...
set_target_properties(unofficial::gumbo::gumbo PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libgumbo.a"
  )

list(APPEND _cmake_import_check_targets unofficial::gumbo::gumbo )
list(APPEND _cmake_import_check_files_for_unofficial::gumbo::gumbo "${_IMPORT_PREFIX}/debug/lib/libgumbo.a" )
